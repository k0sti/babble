//! Theme and styling for the Babble UI
//!
...
impl Theme {
    ...
    pub fn dark() -> Self {
        Self {
            ...
            user_bubble: Color32::from_rgb(99, 102, 241),     // Indigo (matches primary)
            assistant_bubble: Color32::from_rgb(55, 65, 81),  // Gray

            waveform_active: Color32::from_rgb(99, 102, 241), // Indigo
            ...
            bubble_rounding: Rounding::same(16.0),
    ...
    pub fn light() -> Self {
        Self {
            ...
            user_bubble: Color32::from_rgb(79, 70, 229),   // Indigo
            assistant_bubble: Color32::from_rgb(243, 244, 246), // Light gray

            waveform_active: Color32::from_rgb(79, 70, 229), // Indigo
            waveform_inactive: Color32::from_rgb(209, 213, 219), // Light gray
